...
?>
    ...
    <section class="breadcrumb__area breadcrumb__style-3 breadcrumb__spacing-2 include-bg pt-200 pb-235 grey-bg-4" data-background="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/breadcrumb/portfolio-breadcrumb-1.jpg">
        <div class="container">
            <div class="row">
                <div class="col-xxl-7">
            ...
            <div class="row">
                <div class="col-xl-8">
                    ...
                    <div class="portfolio__details-img-list-box mb-10">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/list/portfolio-list-1.jpg" alt="">
                    ...
                    <div class="portfolio__details-img-list-box mb-10">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/list/portfolio-list-2.jpg" alt="">
                    </div>
                    <div class="portfolio__details-img-list-box mb-10">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/list/portfolio-list-3.jpg" alt="">
                    </div>
                    <div class="portfolio__details-img-list-box mb-10">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/list/portfolio-list-4.jpg" alt="">
                    </div>
                    </div>
                </div>
                <div class="col-xl-4">
