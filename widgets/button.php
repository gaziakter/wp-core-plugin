...
class Harry_Button extends Widget_Base {
	...
	protected function render() {
		...
		if ( ! empty( $settings['harry_link']['url'] ) ) {
			...
			$this->add_render_attribute('button_arg', 'class', 'tp-btn-5');
		}


		?>
		<?php if(!empty($settings['harry_button_text'])) : ?>
		<div class="harry-custom-btn">
			<a <?php echo $this->get_render_attribute_string( 'button_arg' ); ?> class="tp-btn-5 "><?php echo esc_html($settings['harry_button_text']); ?></a>
		</div>
		<?php endif; ?>
		<?php
	}
...
$widgets_manager->register( new Harry_Button() );