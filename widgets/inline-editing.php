...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'harry-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title',
			[
				'label' => __( 'Title', 'harry-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'harry-core' ),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'harry-core' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'harry-core' ),
			]
		);
